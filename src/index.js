...
app.get('/manual', (req, res) => {
  ...
  res.send(
    ...
    <p>1-a) Для онлайн-версии (для эмуляторов, реальных устройств) пропишите в файле config.ts:</p>
    <p>var workHost = <b>"https://simple-proxy-server-03.onrender.com"</b></p>
    <p style="max-width: 50%">1-б) Для локальной работы (для симулятора IOS или браузеров в обычном режиме) запустите прокси-сервер (npm start), пропишите в файле config.ts: </p>
